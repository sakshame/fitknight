...
# Media files (e.g., uploaded user images)
MEDIA_URL = "/media/"
...
# Google Maps API Key for geolocation and distance matrix
GOOGLE_MAPS_API_KEY = env('GOOGLE_MAPS_API_KEY')

# CORS configuration  # Change to False in production
